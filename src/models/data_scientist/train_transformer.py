...
class TransformerClassifier(torch.nn.Module):
    ...
    def __init__(self, vocab_size_fens,n_moves, dropout=0.1, d_model=512, n_labels=5, nhead=4, num_encoder_layers=4, dim_feedforward=2048):
    ...
    for epoch_num in range(EPOCHS):
        ...
        with torch.no_grad():
            ...
            for val_input,mask_val_input, target_input,mask_target_input,val_label in val_dataloader:
                ...
                mask_target =mask_target_input.to(device)
                mask_input = mask_val_input.to(device)
